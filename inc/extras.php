					...
					<div class="row nav-links justify-content-between">
						<?php
							...
							if ( get_previous_post_link() ) {
								previous_post_link( '<span class="nav-previous p-2 btn-alp btn-dark">%link</span>', _x( '<i class="fa fa-arrow-left"></i>&nbsp;%title', 'Previous post link', 'understrap' ) );
							}
							if ( get_next_post_link() ) {
								next_post_link( '<span class="nav-next p-2 btn-alp btn-dark">%link</span>',     _x( '%title&nbsp;<i class="fa fa-arrow-right"></i>', 'Next post link', 'understrap' ) );
							}
						?>
					</div><!-- .nav-links -->
				</nav><!-- .navigation -->
...
if ( ! function_exists ( 'partner_post_nav' ) ) {
	function partner_post_nav() {
		// Don't print empty markup if there's nowhere to navigate.
		$previous = ( is_attachment() ) ? get_post( get_post()->post_parent ) : get_adjacent_post( false, '', true );
		$next     = get_adjacent_post( false, '', false );
				...
				<nav class="container navigation post-navigation">
					...
					<div class="row nav-links justify-content-between">
						<?php
							...
							if ( get_previous_post_link() ) {
								previous_post_link( '<span class="nav-previous p-2 btn-alp btn-dark">%link</span>', _x( '<i class="fa fa-arrow-left"></i>&nbsp;Previous Case Study', 'Previous post link', 'understrap' ) );
							}
							if ( get_next_post_link() ) {
								next_post_link( '<span class="nav-next p-2 btn-alp btn-dark">%link</span>',     _x( 'Next Case Study&nbsp;<i class="fa fa-arrow-right"></i>', 'Next post link', 'understrap' ) );
							}
						?>
					</div><!-- .nav-links -->
				</nav><!-- .navigation -->
