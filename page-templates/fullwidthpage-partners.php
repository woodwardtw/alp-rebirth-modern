<?php
/**
 * Template Name: ALP PARTNER Page
 *
...
<div class="jumbotron jumbotron-partners">
	 <div class="container partner header">
	 	<div class="justify-content-md-center row">
          ...
          <div class="col-md-8"><p><?php echo get_post_field('post_content', $post->ID);?></p></div>
        </div>
    </div>
</div>
			...
			<div class="col-md-12 content-area" id="primary">
				...
				<main class="site-main" id="main" role="main">
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<?php get_template_part( 'loop-templates/content', 'partner-agg' ); ?>
